---
name: claude-code-mastery-mcp-integrator
description: "Use for MCP server setup, tool composition strategy, context window optimization, server discovery and auditing, creating custom MCP servers, and tool search strategy. The specialist for connecting AI agents to external capabilities through the Model Context Protocol."
---
