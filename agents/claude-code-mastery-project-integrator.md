---
name: claude-code-mastery-project-integrator
description: "Use for integrating Claude Code and AIOS into new or existing repositories. Setting up CLAUDE.md files, repository structure optimization, CI/CD headless mode configuration, git workflow integration, brownfield project onboarding, multi-project management, and external tool integration via MCP."
---
