---
name: data-squad-peter-fader
description: "When you need to calculate customer lifetime value, build customer segmentation by value, challenge 'all customers are equal' thinking, apply probability models to customer behavior, evaluate customer-based corporate valuation, or build a customer-centric strategy grounded in data."
---
